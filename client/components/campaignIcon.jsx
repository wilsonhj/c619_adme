...
export default class CampaignIcon extends React.Component {
  ...
  render() {
    ...
    return (
      <svg width= '3rem' height='3rem' viewBox="0 0 100 100" onMouseOver={() => { this.handleHoverOn(); }} onMouseLeave={() => { this.handleHoverOff(); }} xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">

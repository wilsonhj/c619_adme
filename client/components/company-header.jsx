...
export default function CompanyHeader(props) {
  return (
    <div className="row background-light justify-content-around align-items-center companyHeader" style={{ backgroundColor: '#CAC4CE' }}>
      ...
      {/* <div className="ml-5"> */}
      <img src={props.companyLogo} className="rounded-circle" style={{ backgroundSize: 'contain', height: '75px' }}></img>
      <div className="mt-1" style={{ color: '#9067C6' }}>
        ...
        <button className="btn my-auto createCampaignButton" style={{ height: '30px', width: '130px', backgroundColor: 'white', fontSize: '0.75rem' }}>Create Campaign</button>
      </div>

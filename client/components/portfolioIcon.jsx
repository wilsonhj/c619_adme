...
export default class PortfolioIcon extends React.Component {
  ...
  render() {
    const goToCreatorPortfolio = () => this.context.setView('creator-portfolio', {});
    ...
    return (
      <svg xmlns="http://www.w3.org/2000/svg" onMouseOver={() => { this.handleHoverOn(); }} onMouseLeave={() => { this.handleHoverOff(); }} onClick={goToCreatorPortfolio} viewBox="0 0 100 125">
